...
### 📹 Камеры (новая возможность в версии 1.1.0)
- Автоматическое обнаружение камер, привязанных к домофонам/воротам
- Прямая потоковая трансляция (HLS) в интерфейсе Home Assistant
- Камера объединяется в одно устройство с кнопкой и сенсором
- Автоматическое обновление токенов для доступа к видеопотоку
